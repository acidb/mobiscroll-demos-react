...
function App() {
  ...
  const refreshJobList = useCallback(
    (currentFilters, currentScheduledIds, rangeStart, rangeDays) => {
  ...
  const rangePopupResponsive = useMemo(
    () => ({
      xsmall: {
        display: 'bottom',
        touchUi: true,
        buttons: [{ text: 'Apply', keyCode: 'enter', handler: applyPendingRange, cssClass: 'mbsc-popup-button-primary' }, 'cancel'],
      },
